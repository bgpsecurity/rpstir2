...
// add
func AddCers(syncLogFileModels []SyncLogFileModel) error {
...
// del
func DelCers(delSyncLogFileModels []SyncLogFileModel, updateSyncLogFileModels []SyncLogFileModel, wg *sync.WaitGroup) (err error) {
	defer func() {
		wg.Done()
	}()
...
func delCerById(session *xorm.Session, cerId uint64) (err error) {
	...
	belogs.Info("delCerById():delete lab_rpki_cer by cerId:", cerId)
	...
	belogs.Debug("delCerById():delete lab_rpki_cer_sia by cerId:", cerId, "  count:", count)
	...
	count, _ = res.RowsAffected()
	belogs.Debug("delCerById():delete lab_rpki_cer_ipaddress by cerId:", cerId, "  count:", count)
	...
	count, _ = res.RowsAffected()
	belogs.Debug("delCerById():delete lab_rpki_cer_crldp by cerId:", cerId, "  count:", count)
	...
	count, _ = res.RowsAffected()
	belogs.Debug("delCerById():delete lab_rpki_cer_asn by cerId:", cerId, "  count:", count)
	...
	count, _ = res.RowsAffected()
	belogs.Debug("delCerById():delete lab_rpki_cer_aia by cerId:", cerId, "  count:", count)
	...
	count, _ = res.RowsAffected()
	belogs.Debug("delCerById():delete lab_rpki_cer by cerId:", cerId, "  count:", count)
