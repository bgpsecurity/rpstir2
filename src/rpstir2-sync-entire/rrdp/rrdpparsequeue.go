...
type RrdpParseQueue struct {
	...
	// jsonutil.MarshalJson(rrQueue.RrdpResult)
...
func (r *RrdpParseQueue) IsClose() bool {
	return r == nil || r.rrdpAddedUrlsMutex == nil
}
...
func (r *RrdpParseQueue) PreCheckRrdpUrl(url string) (ok bool) {
	...
	//chloe.sobornost.net/rpki/news-public.xml
	if strings.Index(url, "https://ca.rg.net/rrdp/notify.xml") > 0 {
