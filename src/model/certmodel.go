...
type MftModel struct {
	...
	MftChainIdsModel MftChainIdsModel `json:"mftChainIdsModel"`
}
...
type MftChainIdsModel struct {
	ParentCerIds []uint64 `json:"parentCerIds"`
}
...
type RoaModel struct {
	...
	EeCertModel      EeCertModel      `json:"eeCertModel"`
	SignerInfoModel  SignerInfoModel  `json:"signerInfoModel"`
	RoaChainIdsModel RoaChainIdsModel `json:"roaChainIdsModel"`
}
...
type RoaChainIdsModel struct {
	ParentCerIds []uint64 `json:"parentCerIds"`
	PeerMftIds   []uint64 `json:"peerMftIds"`
	PeerCrlIds   []uint64 `json:"peerCrlIds"`
}
